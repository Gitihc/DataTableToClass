...
Public Class ProjectPerfoMemberService
    Inherits BaseServices(Of ProjectPerfoMemberModel)
...
#Region "删除"
    ...
    Public Overloads Shared Function Delete(listId As List(Of Integer)) As Boolean
        Return EntityHelper.DeleteMul(Of ProjectPerfoMemberModel)(Function(x) listId.Contains(x.ID))
    End Function
#End Region
End Class