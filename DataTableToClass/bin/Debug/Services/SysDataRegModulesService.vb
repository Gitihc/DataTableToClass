...
Public Class SysDataRegModulesService
    Inherits BaseServices(Of SysDataRegModulesModel)
...
#Region "删除"
    ...
    Public Overloads Shared Function Delete(listId As List(Of Integer)) As Boolean
        Return EntityHelper.DeleteMul(Of SysDataRegModulesModel)(Function(x) listId.Contains(x.ID))
    End Function
#End Region
End Class