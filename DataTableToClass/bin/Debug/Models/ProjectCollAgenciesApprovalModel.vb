...
''' </summary>
''' <remarks></remarks>
Public Class ProjectCollAgenciesApprovalModel
...
Partial Public Class ProjectCollAgenciesApprovalMap
    Inherits EntityTypeConfiguration(Of ProjectCollAgenciesApprovalModel)
	Public Sub New()
		Me.ToTable("ProjectCollAgenciesApproval")
