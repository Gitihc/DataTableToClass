...
''' </summary>
''' <remarks></remarks>
Public Class ProjectCollContractAttachModel
...
Partial Public Class ProjectCollContractAttachMap
    Inherits EntityTypeConfiguration(Of ProjectCollContractAttachModel)
	Public Sub New()
		Me.ToTable("ProjectCollContractAttach")
